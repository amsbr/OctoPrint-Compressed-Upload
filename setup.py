...
plugin_identifier = "compressed_upload"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_compressed_upload"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-Compressed-Upload"
...
# module
plugin_description = """Compressed Upload Support (zip, gz, bz2, tar)"""
...
plugin_url = "https://github.com/amsbr/OctoPrint-Compressed-Upload"
